    ...
    <div class="review-header">
      <div class="review-author">
        ...
        <div class="author-info">
          ...
          <span v-if="review.productName" class="product-name">{{ review.productName }}</span>
        </div>
      </div>
...
const hasRatings = computed(() => {
  return props.review.traitRatings && Object.keys(props.review.traitRatings).length > 0
})
</script>
