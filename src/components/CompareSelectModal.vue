<template>
  <div v-if="show" class="modal-overlay" @click.self="close">
    <div class="modal-content">
      ...
      <p class="hint" v-else>Выберите 2 товара из избранного для сравнения</p>
      ...
      <div v-else class="favorites-list">
        ...
        >
          ...
          <span v-if="currentProduct && item.id === currentProduct.id" class="current-badge"
            >Текущий</span
          >
        </div>
      </div>
      ...
      <div class="modal-actions">
        ...
        <button class="compare-btn" @click="startComparison" :disabled="!canCompare">
