<template>
  <div class="comparison-page">
        ...
        <div class="comparison-table">
          <div class="table-header">
            ...
            <div v-for="product in displayProducts" :key="product.id" class="cell product-header">
              <button @click="removeProduct(product.id)" class="remove-btn" title="Убрать">
                ✕
              </button>
          ...
          <div class="table-section">
            ...
            <div class="table-body">
              <div v-for="trait in allCharacteristics" :key="trait" class="table-row">
          ...
          <div v-if="hasRatings" class="table-section">
            ...
            <div class="table-body">
              <div v-for="rating in allRatings" :key="rating" class="table-row">
                ...
                >
                  <div class="rating-bar">
                    <div
                      class="rating-fill"
                      :style="{ width: (product.traitRatings?.[rating] || 0) * 20 + '%' }"
                    ></div>
                  </div>
    ...
    <CompareSelectModal :show="showSelectModal" :currentProduct="null" @close="closeSelectModal" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getRatingClass(product, rating) {
      ...
      const allRatings = this.products.map((p) => p.traitRatings?.[rating] || 0)
